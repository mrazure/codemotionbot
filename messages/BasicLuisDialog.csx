...
public class BasicLuisDialog : LuisDialog<object>
{
    ...
    public async Task Welcome(IDialogContext context, LuisResult result)
    {
        ...
        try
        {
            ...
            if (!String.IsNullOrEmpty(name))
                await context.PostAsync($"Buongiorno, " + this.name + ",  per interagire e giocare con la nostra intelligenza artificiale puoi digitare cinque comandi : 1) avvia partita 2) regole 3) reset ( per cancellare tutti i tuoi risultati  ) 4) interrompi ( per interrompere una partita ) 5)  risultati ( visualizza tutti i tuoi risultati ) ");
            else
                await context.PostAsync($"Buongiorno,   per interagire e giocare con la nostra intelligenza artificiale puoi digitare cinque comandi : 1) avvia partita 2) regole 3) reset ( per cancellare tutti i tuoi risultati  ) 4) interrompi ( per interrompere una partita ) 5)  risultati ( visualizza tutti i tuoi risultati ) ");
    ...
    public async Task AvviaPartita(IDialogContext context, LuisResult result)
    {
        ...
        var options = new PromptOptions<string>("Fai la tua mossa o termina la partita", null, "Devi selezionare una mossa o termina la partita", new List<string>() { "sasso", "carta", "forbice", "termina" }, 3, new PromptStyler(PromptStyle.None));
    ...
    public async Task FaiLaTuaMossa(IDialogContext context, IAwaitable<string> result)
    {
        ...
        if (roundNumber == 1)
        {
            ...
            roundNumber = 2;
            var options = new PromptOptions<string>("Parziale " + roundResult + " a " + roundResultMachine + " ! Secondo round, fai la tua mossa o termina la partita", null, "Deve selezionare una mossa", new List<string>() { "sasso", "carta", "forbice", "termina" }, 3, new PromptStyler(PromptStyle.None));
            PromptDialog.Choice<string>(context, FaiLaTuaMossa, options);
            //   await context.PostAsync($"Secondo round, fai la tua mossa");
        }
        else if (roundNumber == 2)
        {
            roundNumber = 3;
            //  await context.PostAsync($"Terzo round, fai la tua mossa");
            var options = new PromptOptions<string>("Parziale " + roundResult + " a " + roundResultMachine + " ! Terzo round, fai la tua mossa o termina la partita", null, "Deve selezionare una mossa", new List<string>() { "sasso", "carta", "forbice", "termina" }, 3, new PromptStyler(PromptStyle.None));
            PromptDialog.Choice<string>(context, FaiLaTuaMossa, options);
        }
        else if (roundNumber == 3)
        {
            roundNumber = 4;
            //await context.PostAsync($"Quarto round, fai la tua mossa");
            var options = new PromptOptions<string>("Parziale " + roundResult + " a " + roundResultMachine + " ! Quarto round, fai la tua mossa o termina la partita", null, "Deve selezionare una mossa", new List<string>() { "sasso", "carta", "forbice", "termina" }, 3, new PromptStyler(PromptStyle.None));
            PromptDialog.Choice<string>(context, FaiLaTuaMossa, options);
        }
        else if (roundNumber == 4)
        {
            roundNumber = 5;
            //await context.PostAsync($"Ultimo round, fai la tua mossa");
            var options = new PromptOptions<string>("Parziale " + roundResult + " a " + roundResultMachine + " ! Ultimo round, fai la tua mossa o termina la partita", null, "Deve selezionare una mossa", new List<string>() { "sasso", "carta", "forbice", "termina" }, 3, new PromptStyler(PromptStyle.None));
            PromptDialog.Choice<string>(context, FaiLaTuaMossa, options);
        }
        else
        {
            ...
            var options = new PromptOptions<string>("Partita terminata, vuoi fare una nuova partita o basta?", null, "Deve selezionare una mossa", new List<string>() { "nuova partita", "basta" }, 3, new PromptStyler(PromptStyle.None));
